...
//This static import helps us use the methods of the Mockito class at runtime

/**
 * Created by kingshuk on 8/28/17.
 */
public class TaskManagementServiceImplTest {
    ...
    public void addTaskShouldCreateATask() throws Exception {
        //Here the add task method calls the DAO method addTask(). So we want to mock out that method call
        //As if we're trying to imitate the behavior of the actual service class. We want this addTask method
        ...
        //When is used for conditionally mocking out method calls. When is the trigger. Then is the consequence.

        //This is essentially setting up expectations., step 2 of mocking

        //Basically what I'm telling mockito is that when we make a call to the addTask method of the DAO class then
        //it returns true. Here am forcing the stubbed object to return true when I make a call to the DAO method.
        ...
        //After I have forced the the expectation to be true, am making a call to the actual service method
        ...
        //-->I have mocked out the DAO so what the DAO does is least of my concern here.
        //-->Basically here am testing if the DAO returns true, then the service should return true as well. This is the basic idea here.
        //Am testing the service class's behavior here based on what the DAO returns.
        assertTrue(result);

        //This is the verification part. This does NOT verify the results. It just verifies that when we call the addTask method
        //on the service class, actually the DAO method is getting called.step 3 of mocking
    ...
    public void addTask_should_throw_exception() throws Exception {
        ...
        //Basically what I'm telling mockito is that when we make a call to the addTask method of the DAO class then
        //it throws a null pointer exception. Here am forcing the stubbed object to throw a null pointer exception
        ...
        //This is what is happening here.
        //-->I have mocked out the DAO so what the DAO does is least of my concern here.
        //-->Basically here am testing if the DAO throws a null pointer exception, then the service should
